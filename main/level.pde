...
public class Level extends GameObject {
  ...
  public Level(String levelPath) {
    ...
    enemys.get(0).setPosition(900, 200);
    enemys.get(1).setPosition(1600, 200);
    enemys.get(2).setPosition(2800, 200);
    ...
    /*lives = new ArrayList<Lives>();
     ...
     lives.get(0).setPosition(50, 50);
     lives.get(1).setPosition(60, 50);
     lives.get(2).setPosition(70, 50);*/
    life = new Lives();
